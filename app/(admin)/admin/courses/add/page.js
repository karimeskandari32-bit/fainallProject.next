...
const CKEditor = dynamic(
  () => import("@/components/sections/CKEditor"),
  {
    ssr: false,
...
export default function AddCourse() {
  ...
  const removLesson=(chapterIndex , lessonIndex)=>{
     setChapters((prev) =>
      prev.map((ch, i) =>
        i === chapterIndex
          ? { ...ch, lessons: ch.lessons.filter((lesson, li) => li !== lessonIndex) }
          : ch,
      ),
    );
  };
    ...
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <div className={styles.field}>
          ...
          <CKEditor data={formData.fullDescription}
          onChange={(data) =>
        ...
        <div className={styles.row}>
          ...
          <div className={styles.checkboxField}>
            <label>
              <input type="checkbox"   onChange={handlerChange} name="isFree" checked={formData.isFree} />
        ...
        <div className={styles.row}>
          <div className={styles.field}>
            ...
            <select name="level" value={formData.level} onChange={handlerChange}>
          ...
          <div className={styles.field}>
            ...
            <select name="status" value={formData.status} onChange={handlerChange}>
        ...
        <div className={styles.field}>
          ...
          <input type="file" accept="image/*" required  onChange={handlertumbnailChange} />
          {thumbnailPreview && (
              ...
              >
                ...
                >
                  ...
                  <div className={styles.chapterActions}>
                    ...
                    {chapters.length > 1 && (
                      <button type="button" className={styles.removeChapterBtn}
                      onClick={()=>removeChapters(chIndex)}>
                        حذف فصل
                      </button>
                    )}
                      ...
                      <div key={lesIndex} className={styles.lessonItem}>
                        ...
                        {chapter.lessons.length > 1 && (
                          <button
                            ...
                            onClick={()=>removLesson(chIndex , lesIndex)}
                          >
                            حذف
                          </button>
                        )}
        ...
        {/* دکمه ارسال */}
        <button type="button" onClick={addCourseHandler} disabled={loading} className={styles.submitBtn}>
